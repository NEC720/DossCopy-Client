...
const VerificationNotice = () => {
    ...
    return (
        <Box display="flex" flexDirection="column" alignItems="center" justifyContent="center" height="100vh" bgcolor="#f9fafc" px={3}>
            <Stack
                direction="column"
                spacing={3}
                alignItems="center"
            ...
            >
                ...
                <Typography variant="body1" color="textSecondary">
                    Veuillez vérifier votre adresse email pour activer votre compte. Un email de vérification a été envoyé à{' '}
                ...
                <Button variant="text" color="secondary" onClick={() => navigate('/pages/register/register3')} sx={{ mt: 2 }}>
